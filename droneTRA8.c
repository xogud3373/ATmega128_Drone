...
void Init_Timer3_BLDC(void)
{
    ...
    TCCR3B |= (1<< WGM33)| (1<< WGM32)|(1<<CS31);   // 1분주 14.7456MHz
    ...
    ICR3H = 4608 >> 8;
    ICR3L = 4608 & 0xFF; // TOP값  2500us = 2.5ms
...
interrupt [EXT_INT5] void ext_int5_isr(void)
{
      ...
      else
      {
             ...
             throttle = (4609- cnt_rising + cnt_falling) % 4609;
      }
...
void main(void)
{
    ...
    while(throttle < 2100){} // 송신기로 조금 움직이면(1.1ms 이상) 그 때부터 ESC 동작활성화
    OCR1A = 2003;
    OCR1B = 2003;
